      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        {isLoading ? (
          ...
          <form onSubmit={handleSaveCms} className="space-y-6">
            ...
            <div className="bg-white dark:bg-zinc-900 border border-slate-200/50 dark:border-zinc-800/50 rounded-[32px] p-6 md:p-8 shadow-sm">
              <h2 className="text-lg font-black text-slate-800 dark:text-slate-100 mb-6 flex items-center gap-2">
                <Icon icon="solar:phone-bold-duotone" className="text-primary-500" />
                Informasi Kontak
              </h2>
              ...
              <div className="space-y-4">
                <Input
                  ...
                  onChange={(e) => handleFieldChange('nomor_wa_bisnis', e.target.value)}
                />

                <Input
                  label="URL Instagram"
                  placeholder="https://instagram.com/dstudio"
                ...
                <Input
                  ...
                  placeholder="/storage/qris/qris-image.png"
                  value={formData.qris_image_path}
                  onChange={(e) => handleFieldChange('qris_image_path', e.target.value)}
                />
              </div>
            </div>
