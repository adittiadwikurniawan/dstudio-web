    ...
    <footer className="bg-white dark:bg-zinc-950 border-t border-slate-200/60 dark:border-zinc-900 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-6 mb-12">
        ...
        <div className="flex flex-col gap-4">
          <Link to="/" className="flex items-center gap-2 font-black text-xl tracking-tight text-slate-800 dark:text-slate-100">
            <span className="w-8 h-8 rounded-lg bg-primary-500 flex items-center justify-center text-white font-extrabold text-base">D</span>
          ...
          <div className="flex items-center gap-3 mt-2">
            <a href="https://instagram.com/d_studio" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-slate-100 hover:bg-primary-50 hover:text-primary-500 flex items-center justify-center text-slate-500 transition-colors">
              <Icon icon="bi:instagram" className="w-4 h-4" />
            </a>
            <a href="https://wa.me/6287766086204" target="_blank" rel="noreferrer" className="w-8 h-8 rounded-full bg-slate-100 hover:bg-emerald-50 hover:text-emerald-500 flex items-center justify-center text-slate-500 transition-colors">
              <Icon icon="bi:whatsapp" className="w-4 h-4" />
            </a>
            <a href="mailto:info@dstudiophoto.com" className="w-8 h-8 rounded-full bg-slate-100 hover:bg-sky-50 hover:text-sky-500 flex items-center justify-center text-slate-500 transition-colors">
        ...
        <div className="flex flex-col gap-3.5">
          ...
          <div className="flex flex-col gap-3 text-sm text-slate-600 dark:text-slate-400">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <a href="tel:+6287766086204" className="hover:underline">+62 877-6608-6204</a>
            </div>
            <div className="flex items-center gap-2.5">
              <Icon icon="solar:letter-bold-duotone" className="w-5 h-5 text-slate-400" />
              <a href="mailto:info@dstudiophoto.com" className="hover:underline">info@dstudiophoto.com</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 border-t border-slate-100 dark:border-zinc-900 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-medium text-slate-400">
        ...
        <div className="flex items-center gap-4">
          <a href="#privacy" className="hover:text-slate-600 transition-colors">Kebijakan Privasi</a>
          <a href="#terms" className="hover:text-slate-600 transition-colors">Syarat & Ketentuan</a>
        </div>
      </div>
    </footer>
  );
